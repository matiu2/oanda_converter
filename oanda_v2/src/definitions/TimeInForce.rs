...
pub enum TimeInForce {
    ...
    Gtc,
    /// The Order is “Good unTil Date” and will be cancelled at the
    /// provided time
    Gtd,
    /// The Order is “Good For Day” and will be cancelled at 5pm New
    /// York time
    Gfd,
    /// The Order must be immediately “Filled Or Killed”
    Fok,
    /// The Order must be “Immediately partially filled Or
    /// Cancelled”
    Ioc,
}
